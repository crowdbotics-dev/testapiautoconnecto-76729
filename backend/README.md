...
## Project Structure
    ...
    ├── testapiautoconnecto_76729  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_76729`
...
2. Clone this repo and `cd testapiautoconnecto_76729`
